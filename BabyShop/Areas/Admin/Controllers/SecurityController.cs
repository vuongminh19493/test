...
namespace BabyShop.Areas.Admin.Controllers
{
    public class SecurityController : Controller
    {
        ...
        public RoleManager<ApplicationDbContext.ApplicationRole> RoleManager { get; private set; }

        public SecurityController()
        {
            UserManager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(sdb));
            RoleManager = new RoleManager<ApplicationDbContext.ApplicationRole>(new RoleStore<ApplicationDbContext.ApplicationRole>(sdb));
        }
